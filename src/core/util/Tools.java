...
/*
    public static class CollisionDetection {
        ...
        public static boolean AABBCheck(core.physics.broadphase.AABB object1, core.physics.broadphase.AABB object2) {
            ...
            return (core.util.Tools.between(minimumVertex1.getX(), maximumVertex2.getX(), minimumVertex2.getX()) ||
                    core.util.Tools.between(maximumVertex1.getX(), maximumVertex2.getX(), minimumVertex2.getX()) &&
                    core.util.Tools.between(minimumVertex1.getY(), maximumVertex2.getY(), minimumVertex2.getX()) ||
                    core.util.Tools.between(maximumVertex1.getY(), maximumVertex2.getY(), minimumVertex2.getY()));
        }
        ...
        public static boolean AABBCheck(core.physics.space.Vector2d object1, core.physics.broadphase.AABB object2) {
            ...
            return (core.util.Tools.between(object1.getX(), maximumVertex2.getX(), minimumVertex2.getX()) ||
                    core.util.Tools.between(object1.getX(), maximumVertex2.getX(), minimumVertex2.getX()) &&
                            core.util.Tools.between(object1.getY(), maximumVertex2.getY(), minimumVertex2.getX()) ||
                    core.util.Tools.between(object1.getY(), maximumVertex2.getY(), minimumVertex2.getY()));
        }
